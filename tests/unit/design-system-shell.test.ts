...
const densityCleanupCss = readFileSync('src/styles/aqua-density-cleanup.css', 'utf8');
const dashboardShell = readFileSync('src/components/layout/AquaDashboardShell.tsx', 'utf8');
...
test('route resolution preserves exact and nested dashboard context', () => {
  ...
  assert.deepEqual(resolveAquaRoute('/dashboard/sales/opportunities/opportunity-1'), {
