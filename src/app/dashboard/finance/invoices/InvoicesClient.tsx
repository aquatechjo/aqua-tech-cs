        ...
        <form className="aqua-card p-4 aqua-finance-editor" onSubmit={createInvoice}>
          ...
          <div className="row g-3 mt-2">
            ...
            <div className="col-12 col-lg-3">
              ...
              <output className="form-control aqua-finance-total" dir="ltr">
                {money(preview.subtotal, currency)}
              </output>
            </div>
            <div className="col-12 col-lg-3">
              <label className="form-label">الإجمالي المتوقع</label>
              <output
                className="form-control aqua-finance-total aqua-finance-total--strong"
                dir="ltr"
              >
                {money(preview.total, currency)}
              </output>
            </div>
            <div className="col-12 col-lg-6">
          ...
          <div className="form-check mt-3">
            ...
            />
            <label className="form-check-label" htmlFor="issueImmediately">
              إصدار الفاتورة مباشرة بدل حفظها كمسودة
            </label>
          </div>
      ...
      <div className="aqua-card p-4 aqua-finance-register">
        <div className="row g-2 mb-4">
          <div className="col-12 col-lg-8">
            <input
              className="form-control"
              placeholder="بحث برقم الفاتورة أو العميل أو المشروع"
              value={q}
            ...
            <table className="table table-dark table-hover align-middle mb-0">
              ...
              <tbody>
                {filteredInvoices.map((invoice) => {
                  ...
                  return (
                    <tr key={invoice.id}>
                      <td className="fw-bold text-info" dir="ltr">
                      ...
                      <td>
                        <span className={`badge ${statusClass(invoice.displayStatus)}`}>
                          {statusLabels[invoice.displayStatus]}
                        </span>
                      </td>
                      <td>
                      ...
                      <td className="text-start fw-bold" dir="ltr">
